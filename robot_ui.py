...
class RobotUI:
    ...
    def draw_header(self, tft, title):
        ...
        tft.text((self.center_x(title), 13), title, robot_config.YELLOW, robot_config.FONT, 1)
    ...
    def draw_main_screen(self, tft):
        ...
        tft.text((self.center_x("HOLD SW1 + SW2 = EXIT"), 118), "HOLD SW1 + SW2 = EXIT", robot_config.RED, robot_config.FONT, 1)
    ...
    def draw_trim_screen(self, tft):
        ...
        tft.text((self.center_x("POT1: SELECT"), 110), "POT1: SELECT", robot_config.GREEN, robot_config.FONT, 1)
        tft.text((self.center_x("BT8: SAVE   BT1:+1 BT2:-1"), 122), "BT8: SAVE   BT1:+1 BT2:-1", robot_config.GREEN, robot_config.FONT, 1)
    ...
    def update_joystick_display(self, tft, joy_data, prev_values):
        ...
        for key, (value, x, y) in vals.items():
            if prev_values.get(key) != value:
                ...
                tft.text((x, y), self.pad(value), robot_config.YELLOW, robot_config.FONT, 1)
    ...
    def update_potentiometer_display(self, tft, pot_value, prev_values):
        ...
        if prev_values.get('pot') != pot_value:
            ...
            tft.text((36, 64), self.pad(pot_value), robot_config.YELLOW, robot_config.FONT, 1)
